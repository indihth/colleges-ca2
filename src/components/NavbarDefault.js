...
const NavbarDefault = () => {
  ...
  // Items displayed in navbar with styles
  const navList = (
    <ul className="mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      <Link to="/lecturers" className="flex items-center">
        <Typography
          as="li"
          variant="small"
          color="blue-gray"
  ...
  return (
    <Navbar shadow={false} fullWidth={true} className="bg-opacity-100 border-b-gray-200" >
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <div className="flex items-center gap-x-1">
          {/* Logout button - only display if logged in*/}
          {authenticated ? (
            <Button
              variant="gradient"
              size="sm"
            ...
            // Login button displayed if logged out
